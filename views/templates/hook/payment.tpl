...
<p class="payment_module">
	...
	{if $cprotect == "Y" && $lang_iso == "de"}
		...
		{l s='Buy easy and secure with customer protection by sofortbanking' mod='sofortbanking'}
	{else}
		<img src="{$module_template_dir|escape:'htmlall':'UTF-8'}img/{$mod_lang|escape:'htmlall':'UTF-8'}/banner_300x100.png" alt="banner_300x100.png" title="{l s='Pay with sofortbanking' mod='sofortbanking'}" width="300" height="100" />
		{l s='Pay easy and secure with sofortbanking' mod='sofortbanking'}
	{/if}
	<br class="clear" />
	</a>
</p>