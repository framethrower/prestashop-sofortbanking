...
{/literal}
            ...
            <div><img src="{$sofort.dfl.img_path}/sofortbanking.png" alt="sofortbanking.png" title="" /></div>
            <form method="post" action="{$sofort.dfl.action}">
            <fieldset>
                <legend><img src="{$sofort.dfl.path}/logo.gif" />{l s='Settings'}</legend>
...
<fieldset>
    <legend><img src="{$sofort.dfl.path}/logo.gif" />{l s='URLs'}</legend>
...
<fieldset class="space">
	<legend><img src="../img/admin/unknown.gif" alt="" class="middle" />{l s='Help'}</legend>
